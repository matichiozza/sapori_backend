...
// Redondear a 1 decimal
    ...
    public ResponseEntity<?> inscribirAlumnoEnCurso(@RequestBody InscripcionRequest request) {
        ...
        try {
            ...
            // CREAR PAGO AUTOMÁTICO POR EL IMPORTE DEL CURSO
            // Buscar la cuenta corriente del alumno
            ...
            // Calcular el importe final considerando descuentos del CursoSede
            ...
            // Crear el pago por el importe del curso
            Pago pago = new Pago();
